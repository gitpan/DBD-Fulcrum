/*
  ...
  Check-in date	: $Date: 1998/02/06 17:10:44 $
  Locked by	: $Locker:  $
...
static char rcsid[]="$Id: Fulcrum.xs,v 1.3 1998/02/06 17:10:44 shari Exp $ (c) 1996, Inferentia S.r.l. (Milano) IT";
...
BOOT:
    ...
    DBI_IMP_SIZE("DBD::Fulcrum::dr::imp_data_size", sizeof(imp_drh_t));
    DBI_IMP_SIZE("DBD::Fulcrum::db::imp_data_size", sizeof(imp_dbh_t));
    DBI_IMP_SIZE("DBD::Fulcrum::st::imp_data_size", sizeof(imp_sth_t));
    dbd_init(DBIS);
...
MODULE = DBD::Fulcrum	PACKAGE = DBD::Fulcrum::dr
...
MODULE = DBD::Fulcrum    PACKAGE = DBD::Fulcrum::db
